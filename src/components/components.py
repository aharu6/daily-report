...
class DeleteButtons:
    def __init__(self, page, delete_content, phNameList, phName, drag_data, count_dict, comment_dict, columns, draggable_data_for_move, comments, times, comment, draggable, update_location_data):
        self.page = page
